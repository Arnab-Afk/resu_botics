export default function ContentCard({data}) {
  ...
  const improvements = data.improvement;
  const overallview = data.overallview;
  console.log(data)
          ...
          <div className="mx-auto grid max-w-2xl grid-cols-1 items-start gap-x-8 gap-y-16 sm:gap-y-24 lg:mx-0 lg:max-w-none lg:grid-cols-2">
              ...
              <div className="relative overflow-hidden rounded-3xl bg-gray-900 px-6 pb-9 pt-64 shadow-2xl sm:px-12 lg:max-w-lg lg:px-8 lg:pb-8 xl:px-10 xl:pb-10">
                ...
                <figure className="relative isolate">
                  ...
                  <figcaption className="mt-6 text-sm leading-6 text-gray-300">
                    <strong className="font-semibold text-white">Mark Twain,</strong> highlights the importance of precision and accuracy in language, which is crucial when analyzing resumes.
            ...
            <div>
              <div className="text-base leading-7 text-gray-700 lg:max-w-lg">
                <p className="text-base font-semibold leading-7 text-indigo-600">Analysis Report of your resume </p>
                <h1 className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
                  Views over your resume
                </h1>
                {overallview.map((view , index)=> (
